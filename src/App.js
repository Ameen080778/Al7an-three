  ...
  <style>{`
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .medal-ring-bar {
      ...
      transition: stroke-dashoffset 1.5s .1s cubic-bezier(.16,1,.3,1), stroke .4s ease;
      filter: drop-shadow(0 0 9px currentColor);
    }
    .medal-ring-glow {
      fill:none; stroke-width:16; stroke-linecap:round; opacity:.28; filter:blur(4px);
      transition: stroke-dashoffset 1.5s .1s cubic-bezier(.16,1,.3,1), stroke .4s ease;
    }
    .medal-inner {
    ...
    .success-ticket {
      ...
      background: linear-gradient(160deg, #1b1032 0%, #3a1657 42%, #7c2d8f 78%, #b8860b 100%);
      box-shadow:0 18px 40px rgba(90,20,110,.38), 0 0 0 1px rgba(245,200,66,.15) inset;
    ...
    [data-theme="light"] .success-ticket {
      background: linear-gradient(160deg, #4c1d95 0%, #7e22ce 45%, #c026d3 78%, #f5c842 100%);
      box-shadow:0 18px 40px rgba(124,45,207,.28), 0 0 0 1px rgba(245,200,66,.2) inset;
    }
    ...
    .ticket-school {
      ...
      color:#f5d98a; opacity:.95; margin-bottom:14px; line-height:1.6;
    }
    .ticket-head {
      font-weight:900; font-size:21px; margin-bottom:10px;
      background:linear-gradient(90deg,#ffe9a8,#f5c842 50%,#ffe9a8);
      background-size:200% auto; -webkit-background-clip:text; -webkit-text-fill-color:transparent; background-clip:text;
      animation:shimmer 3.2s linear infinite;
    }
    .ticket-sub  { font-size:13.5px; opacity:.95; line-height:1.9; margin-bottom:18px; font-weight:500; }
    .ticket-perf {
      border-top:2px dashed rgba(255,255,255,.4); position:relative; padding-top:16px; padding-bottom:18px;
    ...
    .ticket-sched-icon {
      ...
      background:rgba(245,200,66,.16); border:1px solid rgba(245,200,66,.35);
    }
    .ticket-sched-label { font-size:11.5px; opacity:.85; margin-bottom:4px; font-weight:600; }
    .ticket-sched-value { font-family:'Aref Ruqaa','Cairo',serif; font-weight:700; font-size:20px; color:#ffe9a8; }
                ...
                {publicStudentResult && (
                  <div style={{ animation:'fadeUp .5s cubic-bezier(.16,1,.3,1) both' }}>
                    ...
                    <div className="medal-wrap">
                      ...
                      {(() => {
                        ...
                        return (
                          <div className="medal-ring">
                            <svg className="medal-ring-svg" viewBox="0 0 190 190">
                      ...
                      <div className="medal-seal" style={{ color:publicStudentResult.grade.color }}>
