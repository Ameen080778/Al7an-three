      ...
      <>
        ...
        <div style={{ width:'100%', maxWidth:420, animation:'fadeUp .55s cubic-bezier(.16,1,.3,1) both' }}>
            <div className="login-card">
              ...
              <button onClick={() => { setCurrentPage('public-lessons'); setStudentResult(null); setStudentCode(''); setResultError(''); }} className="btn btn-violet btn-xl anim-pulse portal-cta" style={{ width:'100%', gap:10 }}>
