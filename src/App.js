  ...
  <style>{`
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .medal-rays {
      ...
      background:repeating-conic-gradient(from 0deg, rgba(244,63,94,.16) 0deg 3deg, transparent 3deg 16deg);
    ...
    .medal-ring {
      ...
      background:var(--bg-card2); border:3px solid var(--gold);
      box-shadow:0 0 0 6px var(--gold-glow), 0 14px 32px rgba(0,0,0,.18);
      animation:popIn .65s cubic-bezier(.34,1.56,.64,1) both;
    }
    .medal-total { font-family:'Aref Ruqaa','Cairo',serif; font-weight:700; font-size:56px; line-height:1; color:var(--gold); animation:numRise .5s .3s cubic-bezier(.16,1,.3,1) both; }
    .medal-of { font-size:11.5px; color:var(--muted); margin-top:2px; }
    .medal-seal {
